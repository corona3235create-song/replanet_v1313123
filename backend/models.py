...
class Challenge(Base):
    ...
    completion_type = Column(Enum(ChallengeCompletionType), default=ChallengeCompletionType.AUTO) # completion_type 필드 추가
...
class ChallengeMember(Base):
    ...
    is_completed = Column(Boolean, default=False) # 챌린지 완료 여부 필드 추가
